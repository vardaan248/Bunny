...
class Calculator:
    def __init__(self,master):
        ...
        self.screen=Text(master,state='disabled',width=30,height=3,background='#5A5A5A',foreground='#FFD4AA')
        ...
        b4=self.createButton(u"\u232B",None) #key to clear (symbol), None is used to clear, if it is not used then symbol printed !
        b5=self.createButton(4)
        b6=self.createButton(5)
        b7=self.createButton(6)
        b8=self.createButton(u"\u00F7") #key to divide (symbol)
        ...
        b17=self.createButton('=',None,width=34) #where 34 is the width of = button
